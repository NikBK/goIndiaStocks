...
const SideBarMenu = () => {
    ...
    return (
        <div className={`${!sideBarExpanded ? "fixed -left-[12rem]" : "relative"} min-w-[12rem] top-1/2 flex flex-col bg-[#1d3b61] text-white text-sm max-sm:fixed max-sm:z-10 max-sm:top-1/4 max-sm:h-screen max-sm:top-[5.5rem]`}>
            ...
            <div onClick={() => setSideBarExpanded(prev => !prev)} className="absolute w-3 h-12 -right-3 max-sm:top-[35%] sm:top-[20%] top-[15%] flex items-center justify-center bg-[#1d3b61] cursor-pointer">
