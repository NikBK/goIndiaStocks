...
const PostBox = () => {
    return (
        <div className="relative overflow-y-scroll h-over-screen">
...
const Post = ({ post }) => {
    return (
        <div className="bg-white shadow-lg m-2">
            {post.companyLogo &&
                <Image src={post.companyLogo} alt="Company Poster" width={300} height={200} className="" />
            }
            <section className="">
                <div className="flex flex-col">
                    <div className="flex items-center">
                        {post.userProfile
                            ...
                            : <FontAwesomeIcon icon={faUser} className="m-2.5" />
                        }
                        <div className="m-2.5">{post.postedBy}</div>
                        <div className={`${post.category.bgColor} m-2.5 text-white py-1 px-2.5 rounded-2xl text-sm`}>{post.category.type}</div>
                    </div>
